...
public class AccountUtils {
    ...
    public static final String VERIFICATION_OTP_SENT_CODE = "004";
    ...
    public static final String ACCOUNT_LOGIN_CODE = "005";
    ...
    public static final String ACCOUNT_INCORRECT_PASSWORD_CODE = "006";
    ...
    public static final String ACCOUNT_IS_VERIFIED_FAILED_CODE = "007";
    ...
    public static final String REFRESH_TOKEN_EXPIRED_CODE = "008";
    ...
    public static final String INVALID_REFRESH_TOKEN_CODE = "009";
    ...
    public static final String REFRESH_TOKEN_BLACKLISTED_CODE = "012";
    ...
    public static final String FORGOT_PASSWORD_EMAIL_CODE = "013";
    ...
    public static final String FORGOT_PASSWORD_PHONE_NUMBER_CODE = "014";
    ...
    public static final String VERIFY_OTP_FAILED_CODE = "016";
    ...
    public static final String RESET_PASSWORD_FAILED_CODE = "019";
    ...
    public static final String RESET_PASSWORD_SUCCESS_CODE = "020";
    ...
    public static final String CHANGE_PASSWORD_FAILED_CODE = "021";
    ...
    public static final String CHANGE_PASSWORD_SUCCESS_CODE = "022";
    ...
    public static final String CREATE_DELIVERY_SUCCESS_CODE = "023";
    ...
    public static final String UPDATE_DELIVERY_SUCCESS_CODE = "024";
    ...
    public static final String CANCEL_DELIVERY_SUCCESS_CODE = "025";
