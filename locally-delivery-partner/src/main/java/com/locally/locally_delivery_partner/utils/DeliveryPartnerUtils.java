...
public class DeliveryPartnerUtils {
    ...
    public static final String VEHICLE_UPDATE_CODE = "004";
    public static final boolean VEHICLE_UPDATE_SUCCESS = true;
    public static final String VEHICLE_UPDATE_MESSAGE = "Vehicle Updated Successfully.";

    public static final String USER_PROFILE_UPDATE_CODE = "004";
